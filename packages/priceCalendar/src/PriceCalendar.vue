                        ...
                        <div class="content">
                            <div class="content-item" v-for="(item, index) in month.one"
                                ...
                                <div class="content-item-div"
                                    ...
                                    <span>{{item.priceCalendarId}}</span>
                                    <div v-if="item.onClick">{{item.priceText ? item.priceText : ''}}</div>
...
<script>
    ...
    export default {
        ...
        props: {
             ...
             * onClickDateList: [
             *    {
             *        date: '2020/02/02', // 可以点击的日期
             *        priceText: '￥88', // TODO显示的价格
             *        price: '88',
             *        ... // 可以为任何属性 点击选择好日期后立即和选择好的日期一起返回
             *    }
             * ]
             * */
            onClickDateList: {
        ...
        methods: {
            ...
            clickDay (item, index, mIndex, onClick) {
                if (item.priceCalendarId && onClick) {
                    this.selectUseDate = item;
            ...
            getWeek (item) {
                ...
                if (item.date) {
                    ...
                    let info = JSON.parse(JSON.stringify(_item))
                    delete info.priceCalendarId
                    return info
                }
            },
            /**
